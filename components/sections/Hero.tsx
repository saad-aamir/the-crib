    ...
    <section className="hero-cream">
      <div className={`hero-cream-inner ${inView ? "in" : ""}`}>
        ...
        <p className="hero-cream-body">
          Four bespoke hillside apartments open year-round for slow, quiet stays above the trees, with a soon to come private cinema room and game room reserved for guests.
        </p>

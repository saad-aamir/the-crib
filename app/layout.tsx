...
const ACCOMMODATIONS = [
  {
    ...
    description:
      "A three-bedroom corner apartment in Murree with two forest-view balconies, reserved game room access and a fully equipped kitchen. Sleeps 9.",
    bedrooms: 3,
    bathrooms: 3,
    sleeps: 9,
    price: 38000,
  ...
  },
  {
    ...
    description:
      "A two-bedroom Murree apartment for smaller families, with a fully furnished lounge, reading nook and private balcony. Easier on the pocket. Sleeps 6.",
    bedrooms: 2,
    bathrooms: 2,
    sleeps: 6,
    price: 25000,
    image: "/apartments/budget/lounge/20260514_132411.jpg",
    amenities: ["Furnished Lounge", "Reading Nook", "Private Balcony", "Full Kitchen"],
  },
  {
    slug: "prestige-suite",
